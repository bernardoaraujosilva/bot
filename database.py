...
CREATE TABLE IF NOT EXISTS bot_config(
    lara_name TEXT DEFAULT 'Daniel lopes da silva',                 -- Nome da lara
    lara_key TEXT DEFAULT '17670088-15da-46c0-9985-729a9e95e504',                                        -- Chave pix da lara
    main_img TEXT DEFAULT 'https://telegra.ph/file/f0ac7b4baf2ed34c51747.png',  -- Link da imagem do /start
    support_user TEXT DEFAULT '@Sueco_BOT',                               -- Username de atendimento
    channel_user TEXT DEFAULT '@bkreferencia',                                    -- Canal de notícias
